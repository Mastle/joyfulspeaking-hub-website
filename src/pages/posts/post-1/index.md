...
My first blog post, which has since been archived, brought an unexpected surprise. That, along with my busy dev work schedule, my main profession, led to a hiatus from writing. The classes didn’t stop and I was researching like crazy the whole time.

The truth is, Joyful Speaking is the second wing of my career as a developer, and it means a lot to me. But I needed a period of recalibration. I started to realize a few things.

First, I was using the wrong channel. It wasn’t only that people don’t read much anymore—it was that my long, detailed posts were never going to reach the everyday learners I wanted to help. The content wasn’t landing in the right circles, and I could feel that the people who most needed simple, practical guidance weren’t seeing any of it.

Second, life got in the way. The plan to grow Joyful Speaking with other teachers had to be paused. A mix of global noise and local disruptions made proper coordination almost impossible. So I made the decision to take the reins on my own for a while, keep things simple, and make sure the project kept moving instead of getting stuck in limbo.
...
I’ll also explore a range of topics related to linguistics, language, and my personal journey as an English teacher — sharing insights, experiences, and reflections along the way. I think adding blogs about other languages will also be a great way to help everyone broaden their communication skills.
...
I want to end this post by sharing a poem that’s deeply meaningful to me: [**“Do not go gentle into that good night”**](https://www.poetryfoundation.org/poems/46569/do-not-go-gentle-into-that-good-night) by Dylan Thomas.

It’s a powerful reminder of what language can do—how a few lines can carry entire lifetimes of emotion. Its message of resisting the fading of light resonates with my own fight to keep language learning alive, accessible, and meaningful for anyone who wants to try.

I’ll be back soon with more of the nerdy language content I love creating. If you’re curious about linguistics, or just want a place to start your journey, feel free to reach out. I’d genuinely love to talk about it with you.
